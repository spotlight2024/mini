...
class Settings:
    ...
    WEBDRIVER_MODE: str = os.getenv("WEBDRIVER_MODE", "remote")  # 可选值：'local' 或 'remote'
    REMOTE_WEBDRIVER_URL: Optional[str] = os.getenv("REMOTE_WEBDRIVER_URL","http://172.16.1.129:4444/wd/hub")
    ...
    SELENIUM_HUB_SUBSCRIBE_PORT: int = int(os.getenv("SELENIUM_HUB_SUBSCRIBE_PORT", "4443"))
    ...
    SELENIUM_NODE_SESSION_TIMEOUT: int = int(os.getenv("SELENIUM_NODE_SESSION_TIMEOUT", "300"))
    ...
    DEVICE_CONNECTION_RETRY_DELAY: int = int(os.getenv("DEVICE_CONNECTION_RETRY_DELAY", "5"))
    ...
    # ==================== 连接池配置 ====================
    CONNECTION_POOL_MAX_CONNECTIONS: int = int(os.getenv("CONNECTION_POOL_MAX_CONNECTIONS", "3"))
    CONNECTION_POOL_MAX_IDLE_TIME: int = int(os.getenv("CONNECTION_POOL_MAX_IDLE_TIME", "300"))
    ...
    # ==================== 证书配置 ====================
    SE_INSTALL_CERTIFICATES: bool = os.getenv("SE_INSTALL_CERTIFICATES", "false").lower() == "true"
    ...
    AUTO_SCALE_ENABLED: bool = os.getenv("AUTO_SCALE_ENABLED", "false").lower() == "true"
    ...
    def validate_config(cls) -> bool:
        ...
        try:
            ...
            if cls.SELENIUM_TIMEOUT <= 0:
                print(f"错误: Selenium超时时间必须大于0，当前值: {cls.SELENIUM_TIMEOUT}")
                return False
            ...
            if cls.WEBDRIVER_MODE not in ["local", "remote"]:
                print(f"错误: WebDriver模式必须是 'local' 或 'remote'，当前值: {cls.WEBDRIVER_MODE}")
                return False
